#ifndef ORPROCESSINGPASSSHADER_H
#define ORPROCESSINGPASSSHADER_H
...
class ORprocessingPassShader : public GfxShaderProgram {
...
public:
	...
	///////////////////////////////////////////////////////////////////////
	ORprocessingPassShader(Shader::compConstMap_t compileConsts) : GfxShaderProgram("o_processingPass", "deferred_fullscreenquad.vert", "o_processgdlbuf.frag", nullptr, compileConsts) {		
		// input
		glBindAttribLocation(getId(), Renderable::v_positionLoc,  "positionNDC");

		// output
		glBindFragDataLocation(getId(), AoBuffer::AOBUFFER_TEXTURE_TYPE_AO, "aoColor");
		//glBindFragDataLocation(getId(), AoBuffer::AOBUFFER_TEXTURE_TYPE_DIRLIGHT, "FragColor");
		//glBindFragDataLocation(getId(), AoBuffer::AOBUFFER_TEXTURE_TYPE_DIRLIGHT, "albedoTexData");
