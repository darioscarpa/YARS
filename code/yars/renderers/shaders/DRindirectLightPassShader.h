#ifndef DRINDIRECTLIGHTPASSSHADER_H
#define DRINDIRECTLIGHTPASSSHADER_H
...
class DRindirectLightPassShader : public GfxShaderProgram {
...
public:
	...
	///////////////////////////////////////////////////////////////////////
	DRindirectLightPassShader(Shader::compConstMap_t compileConsts) : GfxShaderProgram("d_indirectLightPass", "deferred_fullscreenquad.vert", "deferred_indirectlightpass.frag", nullptr, compileConsts) {		
		// input
	...
	~DRindirectLightPassShader() {};
	///////////////////////////////////////////////////////////////////////	
	inline void setMousePos(glm::vec2 mouseCoords)            {setVec2Uniform(mousePos, mouseCoords); }
			
	inline void setILsamples(int samples)            { setIntUniform(aoSamples,           samples); };
	inline void setILradLength(float samples)        { setFloatUniform(radLength,         samples); };
	inline void setILdiskDisplacement(float samples) { setFloatUniform(diskDisplacement,  samples); };
	inline void setILdistMax(float samples)          { setFloatUniform(distMax,           samples); };
