#ifndef BLURPASSSHADER_H
#define BLURPASSSHADER_H
...
class BlurPassShader : public GfxShaderProgram {
...
public:
	...
	///////////////////////////////////////////////////////////////////////
	BlurPassShader() : GfxShaderProgram("c_blurPass", "deferred_fullscreenquad.vert", "blur.frag") {		
		// input
		...
		setTextureSampler(TEX_AO,       "aoSampler",		  GdlBuffer::GDLBUFFER_TEXTURE_AVAILABLE + AoBuffer::AOBUFFER_TEXTURE_TYPE_AO);
